<?php
  ...
  $books = [
    ...
    ['id' => 4, 'title' => 'The Short Legs of Lies', 'author' => 'J.R.R Tolkien', 'description' => 'Set in Middle-earth, the story began as a sequel to book The Hobbit but eventually developed into a much larger work.'],
